...
const pool = mysql.createPool({
    ...
    database: process.env.DB_NAME || process.env.MYSQLDATABASE || 'calvoro_db',
...
class CalvoroMySQLDatabase {
    ...
    async init() {
        try {
            ...
            console.error('MySQL database init error:', e);
        }
    }
    ...
    async ensureCoreTables() {
        ...
        try {
            ...
            const [catRows] = await this.pool.query('SELECT COUNT(*) as count FROM categories');
